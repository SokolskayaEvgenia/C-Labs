...
namespace Massiv
{
    class Methods
    {
        ...
        public static double SumNegativIndex(double[] a) // сумма элементов массива с нечетным номером
        {
            double sum = 0;
        ...
        public static double SumPosIndex(double[] a) // сумма элементов массива с четным номером
        {
            double sum = 0;
