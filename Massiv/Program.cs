    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                double SumOddElements = Methods.SumOddElem(Mass);
                Console.WriteLine("Сумма элементов массива с нечетными номерами = {0}", SumOddElements);

                double SumEvenElements = Methods.SumEvenElem(Mass);
                Console.WriteLine("Сумма элементов массива с четными номерами = {0}", SumEvenElements);
